    ...
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, -Math.PI / 2]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[24.05, 117.48, 10.53]} rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <mesh geometry={nodes.Object_4.geometry} material={materials['Material.009']} position={[18.96, 117.48, 10.53]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
          <mesh geometry={nodes.Object_9.geometry} material={materials['Material.012']} position={[42.71, 209.04, 23.56]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
